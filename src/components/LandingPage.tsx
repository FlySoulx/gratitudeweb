  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      <motion.section
        ...
        className="py-20 px-6 max-w-6xl mx-auto"
      >
        <div className="bg-white backdrop-blur-sm rounded-3xl p-12 border border-gray-200 shadow-2xl">
          <div className="text-center mb-8">
            <div className="flex items-center justify-center space-x-3 mb-6">
              ...
              <h2 className="text-4xl font-bold text-gray-900">IKE: International Keepers of Excellence</h2>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-purple-800 mb-4">IKE is Forever</h3>
            ...
            >
              <div className="bg-gray-50 border border-gray-200 rounded-xl p-6">
                <h4 className="text-lg font-bold text-indigo-600 mb-3 flex items-center space-x-2">
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-xl p-6">
                <h4 className="text-lg font-bold text-purple-600 mb-3 flex items-center space-x-2">
            ...
            >
              ...
              <footer className="text-sm text-gray-600 mb-4">— IKE Coin</footer>
